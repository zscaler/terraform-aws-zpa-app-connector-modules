...
**Note:** EBS volume size is inherited from the AMI and automatically meets the requirements for the selected instance type. This follows the same pattern as the App Connector modules.
...
| <a name="input_name_prefix"></a> [name\_prefix](#input\_name\_prefix) | A prefix to associate to all the Workload module resources | `string` | n/a | yes |
...
| <a name="input_resource_tag"></a> [resource\_tag](#input\_resource\_tag) | A tag to associate to all the Workload module resources | `string` | `""` | no |
