...
module "appconnector-vm" {
  ...
  depends_on = [module.security_vpc, module.security_subnet_sets, module.natgw_set, module.security_vpc_routes,
  module.zpa_app_connector_group, aws_ssm_parameter.this]
}
